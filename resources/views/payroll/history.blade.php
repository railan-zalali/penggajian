                            ...
                            <td class="py-3 px-6 text-center">
                                @if ($payroll->payment_status == 'paid')
                                    ...
                                    @if ($payroll->payment_confirmed)
                                        <span
                                            class="px-2 py-1 bg-blue-100 text-blue-800 rounded-full text-xs ml-1 inline-block">
                                            Dikonfirmasi
                                            @if ($payroll->payment_confirmed_at)
                                                {{ $payroll->payment_confirmed_at->format('d M Y') }}
                                            @endif
                                        </span>
                                    @elseif($payroll->payment_status == 'paid')
                                        <span
                                            class="px-2 py-1 bg-yellow-100 text-yellow-800 rounded-full text-xs ml-1 inline-block">
                                            Belum dikonfirmasi
                                        </span>
                                    @endif
